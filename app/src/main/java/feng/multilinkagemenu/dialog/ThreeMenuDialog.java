package feng.multilinkagemenu.dialog;
...
import feng.multilinkagemenu.adapter.MenuDialogAdapter;
import feng.multilinkagemenu.adapter.MyPagerAdapter;
import feng.multilinkagemenu.bean.MenuData;
import feng.multilinkagemenu.utils.MenuDataManager;
import feng.multilinkagemenu.view.MyViewPager;
    ...
    private void initViews() {
        ...
        mListView3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //从第三级菜单的基础上加载第四级菜单
                MenuData menuData = (MenuData) parent.getItemAtPosition(position);
                List<MenuData> list4 = mDictDataManager.getTripleColumnData(mContext, menuData.id);
